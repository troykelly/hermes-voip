...
- [ ] **[high] efficiency** — Add and enforce an AEC hot-path CPU budget before enabling the current default-cap path on 16 kHz calls. (`src/hermes_voip/media/engine.py`, `src/hermes_voip/media/aec.py`, `src/hermes_voip/config.py`)
