...
# UCM-class gateway that did NOT negotiate rtcp-mux MUTED the media session on that
...
def _parse_port(env: Mapping[str, str], transport: str) -> int:
    ...
    # alias). A real UCM-class gateway provisioner exports BOTH HERMES_SIP_PORT=5060
